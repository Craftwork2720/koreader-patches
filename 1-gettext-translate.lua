...
local translations = {
    ...
    ["Any path fragment will match — e.g. 'Comics' excludes all folders and files containing that name."] = "Dopasowuje dowolny fragment ścieżki — np. 'Komiksy' wyklucza wszystko zawierające tę nazwę.",
    ["/path/to/folder"]                          = "/ścieżka/do/folderu",
    ["Cancel"]                                   = "Anuluj",
    ["Add"]                                      = "Dodaj",
    ["Already in the list."]                     = "Już jest na liście.",
    ["file"]                                     = "plik",
    ["folder"]                                   = "folder",
    ["✓ Ignored in History"]                     = "✓ Ignorowane w historii",
    ["Ignore in History"]                        = "Ignoruj w historii",
    [" added to exclusion list. Existing entries will be removed on next History open."] = " dodano do wykluczeń. Istniejące wpisy znikną przy następnym otwarciu historii.",
    ["✓ Ignored in Statistics"]                  = "✓ Ignorowane w statystykach",
    ["Ignore in Statistics"]                     = "Ignoruj w statystykach",
    ["Exclude Folders & Files"]                  = "Wyklucz foldery i pliki",
    ...
    ["Change will take effect after reopening the book."] = "Zmiana wejdzie w życie po ponownym otwarciu książki.",
